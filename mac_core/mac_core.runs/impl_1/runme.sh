...
HD_PWD='C:/Users/nguye/Desktop/LAB/SoC/BTL/mac-tvla-verification/mac_core/mac_core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac_core.tcl -notrace
