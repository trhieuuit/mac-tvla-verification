...
HD_PWD='C:/Users/nguye/Desktop/LAB/SoC/BTL/mac-tvla-verification/mac_core/mac_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_core.tcl
