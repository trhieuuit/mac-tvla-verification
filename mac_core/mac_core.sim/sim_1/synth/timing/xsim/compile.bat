...
REM
REM Generated by Vivado on Sun May 03 18:17:01 +0700 2026
...
echo "xvlog --incr --relax -prj tb_pipeline_mac_core_vlog.prj"
call xvlog  --incr --relax -prj tb_pipeline_mac_core_vlog.prj -log xvlog.log
