...
REM
REM Generated by Vivado on Sun May 03 19:40:15 +0700 2026
...
echo "xvlog --incr --relax -prj tb_mac_core_vlog.prj"
call xvlog  --incr --relax -prj tb_mac_core_vlog.prj -log xvlog.log
